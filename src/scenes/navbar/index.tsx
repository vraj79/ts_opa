...
const Navbar = ({ isTopOfPage,selectedPage, setSelectedPage }: Props) => {
    ...
    return (
        <nav>
            <div className={`${navbarBackground} ${flexBetween} fixed top-0 z-50 w-full py-6`}>
                <div className={`${flexBetween} mx-auto w-5/6`}>
                    <div className={`${flexBetween} w-full gap-16`}>
                        ...
                        {/* Right Side */}
                        {isAboveMedScreens ? (<div className={`${flexBetween} w-full`}>
            ...
            {/* Mobile View */}
            {
                !isAboveMedScreens && isMenuToggled && (
                    <div onClick={()=>setIsMenuToggled(!isMenuToggled)} className="fixed right-0 bottom-0 z-40 h-full w-[300px] bg-primary-500">
                        {/* Close Icon */}
